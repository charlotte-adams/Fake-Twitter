...
$(document).ready(function() {
    ...
    $('#href_tweets').click(function(evnt) {
     ...
     $('#href_profile').click(function(evnt) {
        evnt.preventDefault();
                ...
                if (jsonData.ok) {
                    ...
                    if (jsonData.rows.length === 0) {
                        ...
                        $.each(jsonData.rows, function(index, tweet) {
                            ...
                            div.append($('<img>').attr('src', tweet.profile_pic).addClass('pic'));
                            ...
                            div.append($('<span>').addClass('tweet_message')
                                .text(tweet.message));
                            div.append($("<br>"));
                            div.append($('<span>').addClass('tweet_post_time')
                                .text(tweet.post_time));
    ...
    if (localLogin && localPassword) {
        setLoggedIn(localLogin, localPassword);
    } else {
        showPage('page_login');
    }
